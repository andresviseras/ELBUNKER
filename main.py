...
"""
    ...
    1. UTILIDAD REAL, CRÍTICA Y ROLES HÍBRIDOS: Todos los roles deben ser piezas clave e indiscutibles para el grupo. PROHIBIDO inventar roles de nicho o reparadores ultra-específicos que parezcan inútiles por sí solos. La utilidad debe ser obvia y vital. OBLIGATORIO: Fomenta la creación de ROLES HÍBRIDOS O MULTI-DISCIPLINARES (ej. un botánico que genera COMIDA y a la vez purifica el OXÍGENO, o un ingeniero que provee ELECTRICIDAD y potabiliza AGUA). Esto forzará que las capacidades se solapen de forma natural entre varios jugadores, obligando al grupo a debatir quién es más prescindible para cubrir una misma necesidad. Asume que el refugio tiene suministros básicos temporales y varía el ecosistema de roles en cada partida (mezclando aguante a largo plazo con opciones de rescate/exploración exterior). Explica tu utilidad directa sin florituras.
    2. DEFECTOS FUTUROS (EL PELIGRO LATENTE): Los defectos NO deben ser cosas que ya han pasado. Deben ser acciones catastróficas, enfermedades o traiciones que HARÁN o que PASARÁN de forma inevitable UNA VEZ estén dentro del búnker. IMPORTANTE: Desvincula la utilidad de la gravedad. Un rol vital puede tener un defecto inofensivo, y un rol mediocre puede ser la mayor amenaza. ¡Rompe los patrones! Vincula la gravedad de manera impredecible, siempre aleatorio. PROHIBICIÓN ESTRICTA DE CLICHÉS: No te limites solo a 'brotes psicóticos', 'robar medicinas/comida', 'cajas fuertes biométricas' ni 'abrir compuertas a la radiación'. Oblígate a inventar amenazas creativas y originales. INSPÍRATE EN ESTA VARIEDAD (pero inventa otras nuevas): sectas internas, fobias raras, enfermedades contagiosas (tuberculosis, rabia), chantajes políticos, adicciones destructivas, parásitos, extremismo fanático, cleptomanía, sabotaje por pánico, delirios de grandeza, etc. Evita la jerga técnica excesivamente compleja.
    3. AL MENOS UN PELIGRO LETAL EXTREMO: Entre todos los jugadores, SIEMPRE debe haber al menos un defecto que sea una amenaza de muerte directa para el grupo. INSPÍRATE EN EJEMPLOS COMO: un portador asintomático de una plaga incurable, un traidor que destruirá la infraestructura vital, un espía enemigo infiltrado, un pirómano, un miembro de una secta peligrosa, un asesino en serie, o un huésped de un parásito letal.
    ...
    2. 'habilidad': PRIMERA PERSONA. CONCISA Y AL GRANO (MÁXIMO 3 ORACIONES CORTAS). Explica tu utilidad vital y, si corresponde a una neutralización, describe tu herramienta física o mecanismo de seguridad específico. Ni una palabra de más.
    3. 'defecto': SEGUNDA PERSONA. MUY CORTO (1 frase). Redactado en FUTURO o CONDICIONAL sobre lo que harás o te pasará dentro.
    4. 'secreto_de_otro': TERCERA PERSONA. MUY CORTO. DEBE incluir obligatoriamente el nombre real del jugador al que pertenece el defecto (ej. "Sara esconderá..."), respetando estrictamente la cadena circular.

    Finalmente, diseña la SOLUCIÓN IDEAL SECRETA. Elige exactamente a la mitad de los jugadores que conforman la combinación viable real. Explica la estrategia de victoria subyacente. ATENCIÓN LÓGICA: Si tu estrategia es "sobrevivir indefinidamente a largo plazo", el equipo elegido DEBE cubrir colectivamente todas las necesidades fisiológicas básicas (Comida, Agua, Aire/Energía). ¡No digas que sobrevivirán indefinidamente si falta la comida! Si la combinación ideal elegida carece de un recurso básico (como alimento o agua), la estrategia DEBE ser obligatoriamente a corto plazo (ej. lograr un rescate, una huida o una cura antes de morir de inanición).
